    ...
    <div class="bg-secondary relative py-20 px-4 flex md:flex-row md:px-6 sm:justify-center flex-col items-center gap-24">
        ...
        <div class="sm:order-3">
            <ul class="grid grid-cols-2 gap-7">
                <li><a target="_blank" href="https://api.whatsapp.com/send?phone=523328131753&text=Hola,%20necesito%20ayuda"><img src="{{ asset('assets/icons/socials/WhatsApp Inc.svg') }}" alt="WhatsApp"></a></li>
